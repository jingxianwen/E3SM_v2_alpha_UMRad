...
ACMEROOT="/global/homes/x/xianwen/model/E3SM-V2_modified"	# source code
...
#switch="ALLon"
switch="noEmis"
CASEID="E3SMv2_offline_ICEFLAG3_${switch}"
...
empty_htapes = .false.
mfilt=1
fincl1 = "QRL_OFF","QRLC_OFF","FLNT_OFF","FLUT_OFF","FLUTC_OFF","FLNTC_OFF","FLNS_OFF",
         "FLDSC_OFF","FLNSC_OFF","LWCF_OFF","FLN200_OFF","FLN200C_OFF","FLDS_OFF","FLDSC"
EOF
