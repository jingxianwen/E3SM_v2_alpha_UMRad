...
set job_name       = CMIP_RRTMG_UMRad_scat_offline
...
set ensnum = "ens0" 
set pertlim = 0.d-14
set case_name = ${job_name}.ne30_ne30.cori-knl-${ensnum}
...
cat <<EOF >> user_nl_cam
 ...
 flag_rtr2=.true.
 flag_scat=.true.
 fincl1="QRL","QRLC","FLNT","FLUT","FLUTC","FLNTC","FLNS","FLDSC","FLNSC","LWCF","FLDS",
        "QRL_OFF","QRLC_OFF","FLNT_OFF","FLUT_OFF","FLUTC_OFF","FLNTC_OFF","FLNS_OFF",
	"FLDSC_OFF","FLNSC_OFF","LWCF_OFF","FLDS_OFF"
EOF
